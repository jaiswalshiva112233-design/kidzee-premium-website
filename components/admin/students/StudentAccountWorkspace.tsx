  ...
  return (
    <div className="space-y-6">
      ...
      <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-5">
        ...
        <Metric icon={CalendarClock} label="Upcoming bill" value={upcomingInvoice ? formatMoney(upcomingInvoice.pendingAmount) : "Not generated"} note={upcomingInvoice?.feePeriodLabel?.replace(/^Admission contract\s*·\s*/i, "").trim() ?? "Refresh dues when ready"} />

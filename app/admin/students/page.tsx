              ...
              programmeDefinitions={programmeDefinitions.map((programme) => ({
                ...
                feeVersion: programme.feeVersions[0]
                  ? {
                      ...
                      admissionFeeName: programme.feeVersions[0].admissionFeeName,
                      annualFeeName: programme.feeVersions[0].annualFeeName,
                      kitFeeName: programme.feeVersions[0].kitFeeName,
                      customFees: (programme.feeVersions[0].customFees as any) || [],
